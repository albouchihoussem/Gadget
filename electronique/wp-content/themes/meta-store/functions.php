...
if (!function_exists('meta_store_setup')) :
    ...
    function meta_store_setup() {
         ...
         */
        load_theme_textdomain('meta-store');
...
function meta_store_scripts() {
    ...
    /** Custom Scripts */
    wp_enqueue_script('meta-store-navigation', get_template_directory_uri() . '/js/superfish.js', array(), META_STORE_VERSION, true);
...
function meta_store_fonts_url() {
    ...
    $fonts = $standard_font_family = $font_family_array = $variants_array = $font_array = $google_fonts = array();
