...
$wp_customize->add_control(new Meta_Store_Heading_Control($wp_customize, 'meta_store_content_color_heading', array(
    'section' => 'colors',
    'label' => esc_html__('Content Color', 'meta-store')
)));

$wp_customize->add_setting('meta_store_color_content_info', array(
    'sanitize_callback' => 'meta_store_sanitize_html'
));

$wp_customize->add_control(new Meta_Store_Info($wp_customize, 'meta_store_color_content_info', array(
    'section' => 'colors',
