...
$wp_customize->add_control(new Meta_Store_Image_Select($wp_customize, 'meta_store_blog_layout', array(
...
$wp_customize->add_setting('meta_store_archive_excerpt_length', array(
    'sanitize_callback' => 'meta_store_sanitize_number_absint',
    'default' => 100
));

$wp_customize->add_control(new Meta_Store_Range_Slider($wp_customize, 'meta_store_archive_excerpt_length', array(
    'section' => 'meta_store_blog_page_settings',
    'label' => esc_html__('Excerpt Length (words)', 'meta-store'),
    'input_attrs' => array(
        'min' => 50,
        'max' => 200,
        'step' => 1
...
$wp_customize->add_control(new Meta_Store_Range_Slider($wp_customize, 'meta_store_blog_excerpt_length', array(
    'section' => 'meta_store_blog_page_settings',
    'label' => esc_html__('Excerpt Length', 'meta-store'),
    'description' => esc_html__('(in Chars)', 'meta-store'),
    'input_attrs' => array(
        'min' => 0,
        'max' => 500,
        'step' => 1
...
$wp_customize->add_control(new Meta_Store_Switch($wp_customize, 'meta_store_blog_date', array(
    'section' => 'meta_store_blog_page_settings',
...
$wp_customize->add_control(new Meta_Store_Switch($wp_customize, 'meta_store_blog_author', array(
    'section' => 'meta_store_blog_page_settings',
...
$wp_customize->add_control(new Meta_Store_Switch($wp_customize, 'meta_store_blog_comment', array(
    'section' => 'meta_store_blog_page_settings',
...
$wp_customize->add_control(new Meta_Store_Switch($wp_customize, 'meta_store_blog_category', array(
    'section' => 'meta_store_blog_page_settings',
...
$wp_customize->add_control(new Meta_Store_Switch($wp_customize, 'meta_store_blog_tag', array(
    'section' => 'meta_store_blog_page_settings',
...
$wp_customize->add_control(new Meta_Store_Image_Select($wp_customize, 'meta_store_single_layout', array(
...
$wp_customize->add_control(new Meta_Store_Switch($wp_customize, 'meta_store_single_categories', array(
    'section' => 'meta_store_single_post_settings',
...
$wp_customize->add_control(new Meta_Store_Switch($wp_customize, 'meta_store_single_author', array(
    'section' => 'meta_store_single_post_settings',
    'label' => esc_html__('Display Author', 'meta-store')
)));
...
$wp_customize->add_control(new Meta_Store_Switch($wp_customize, 'meta_store_single_date', array(
    'section' => 'meta_store_single_post_settings',
    'label' => esc_html__('Display Posted Date', 'meta-store')
)));
...
$wp_customize->add_control(new Meta_Store_Switch($wp_customize, 'meta_store_single_comment_count', array(
    'section' => 'meta_store_single_post_settings',
...
$wp_customize->add_control(new Meta_Store_Switch($wp_customize, 'meta_store_single_tags', array(
    'section' => 'meta_store_single_post_settings',
