...
$wp_customize->add_control(new Meta_Store_Heading_Control($wp_customize, 'meta_store_top_footer_heading', array(
    'section' => 'meta_store_footer_settings',
...
$wp_customize->add_control(new Meta_Store_Image_Chooser($wp_customize, 'meta_store_footer_col', array(
    'section' => 'meta_store_footer_settings',
...
$wp_customize->add_control(new Meta_Store_Alpha_Color_Picker($wp_customize, 'meta_store_footer_border_color', array(
...
$wp_customize->add_control(new Meta_Store_Heading_Control($wp_customize, 'meta_store_bottom_footer_heading', array(
    'section' => 'meta_store_footer_settings',
...
$wp_customize->add_setting('meta_store_footer_copyright', array(
    'sanitize_callback' => 'meta_store_sanitize_text',
    'default' => esc_html__('&copy; 2020 Viral News. All Right Reserved.', 'meta-store'),
    'transport' => 'refresh'
));
