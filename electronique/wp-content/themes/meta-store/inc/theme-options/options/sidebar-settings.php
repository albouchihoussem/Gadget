...
$wp_customize->add_control(new Meta_Store_Image_Chooser($wp_customize, 'meta_store_page_layout', array(
...
$wp_customize->add_control(new Meta_Store_Image_Chooser($wp_customize, 'meta_store_post_layout', array(
    'section' => 'meta_store_sidebar_settings',
...
$wp_customize->add_control(new Meta_Store_Image_Chooser($wp_customize, 'meta_store_archive_layout', array(
    'section' => 'meta_store_sidebar_settings',
...
$wp_customize->add_control(new Meta_Store_Image_Chooser($wp_customize, 'meta_store_home_blog_layout', array(
    'section' => 'meta_store_sidebar_settings',
...
$wp_customize->add_control(new Meta_Store_Image_Chooser($wp_customize, 'meta_store_search_layout', array(
    'section' => 'meta_store_sidebar_settings',
...
$wp_customize->add_control(new Meta_Store_Image_Chooser($wp_customize, 'meta_store_shop_layout', array(
    'section' => 'meta_store_sidebar_settings',
