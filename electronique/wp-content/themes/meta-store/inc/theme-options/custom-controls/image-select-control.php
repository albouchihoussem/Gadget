...
class Meta_Store_Image_Select extends WP_Customize_Control {

    public $type = 'meta-store-image-select';
    ...
    public function render_content() {
        if (!empty($this->choices)) {
            ...
            <label>
                ...
                <select class="ms-select-image" <?php $this->link(); ?>>
                    <?php
                ...
                <div class="ms-select-image-container"><img src="<?php echo esc_url( $this->image_path . $this->value() ); ?>.png"/></div>
            </label>
            <?php
        }
    }
