...
/** Color Tab Control */
class Meta_Store_Color_Tabs extends WP_Customize_Control {

    public $type = 'meta-store-color-tabs';
    ...
    protected function content_template() {
        ...
        <div class="ms-color-tab-wrap" style="display:none">
            ...
            <div class="ms-color-tab-contents">
                <div class="ms-color-tab-content-normal" style="display:block">
                    ...
                    <div class="ms-color-content-wrap {{ key }}">
                        ...
                        <input class="ms-alpha-color-input" type="text" value="{{ args.value }}" data-alpha="{{ data.show_opacity }}" data-default-color="{{ args.default }}" data-palette="{{ data.palette }}" {{{ args.link }}} />   
                    </div>
                    <# } ); #>
                </div>
