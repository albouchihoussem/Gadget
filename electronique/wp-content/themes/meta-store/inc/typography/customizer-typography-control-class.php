 ...
 * @access public
 */
class Meta_Store_Typography_Control extends WP_Customize_Control {
     ...
     * @var    string
     */
    public $type = 'meta-store-typography';
        ...
        <ul>
            ...
            <li class="typography-color">
                ...
                <div class="customize-control-content">
                    <input class="color-picker-hex" type="text" maxlength="7" placeholder="<?php esc_attr_e('Hex Value', 'meta-store'); ?>" {{{ data.typocolor.link }}} value="{{ data.typocolor.value }}"  />
                </div>
            </li>
            <# } #>
    ...
    public function get_font_weight_choices() {
        if ($this->settings['family']->id) {
            ...
            $meta_store_font = array_merge($meta_store_standard_font, $meta_store_google_font);
