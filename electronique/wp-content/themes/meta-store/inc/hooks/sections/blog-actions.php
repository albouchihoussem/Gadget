    ...
    if (!function_exists('meta_store_single_post_content')) {
        function meta_store_single_post_content() {
            ...
            if ('single-layout1' == $post_layout) {
                meta_store_single_post_layout1();
            } else {
                meta_store_single_post_layout2();
            }
        }
    }
...
if (!function_exists('meta_store_single_post_layout1')) {

    function meta_store_single_post_layout1() {
        ...
        if (has_post_thumbnail()) {
            ...
            <div class="ms-single-featured-image">
                <img src="<?php echo esc_url($img[0]); ?>" alt="<?php echo esc_attr(meta_store_get_altofimage(absint(get_post_thumbnail_id()))); ?>" />
            </div>
            <?php
        }
        ?>
...
if (!function_exists('meta_store_single_post_layout2')) {

    function meta_store_single_post_layout2() {
        $display_author = get_theme_mod('meta_store_single_author', 1);
        $display_category = get_theme_mod('meta_store_single_categories', 1);
