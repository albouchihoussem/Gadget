            ...
            function meta_store_bottom_footer_cb() {
                ...
                <div class="ms-bottom-footer">
                    <div class="ms-bottom-footer-left">
                        <?php
                        $copyright_text = get_theme_mod('meta_store_footer_copyright', '&copy; 2020 Meta Store');
                        echo esc_html($copyright_text) . ' | ' . esc_html__( 'WordPress Theme by ', 'meta-store' ) . '<a href="https://mysticalthemes.com/">' . esc_html__( 'Mystical Themes', 'meta-store' ) . '</a>';
                        ?>
                    </div>
