    ...
    if (!function_exists('meta_store_top_header_cb')) {
        ...
        function meta_store_top_header_cb() {
            ...
            if ($top_header_display !== 'none') {
                ?>
                <div class="ms-top-header <?php echo esc_attr($top_header_class); ?>">
...
if (!function_exists('meta_store_inner_page_banner_cb')) {
    ...
    function meta_store_inner_page_banner_cb() {
        ...
        if (is_singular('post')) {
            ...
            $banner_style = get_theme_mod('meta_store_banner_style', 'banner-style1');
            ?>
            <div class="ms-page-banner <?php echo 'ms-' . esc_attr($banner_style); ?>">
                <div class="ms-container">
