...
add_action('wp_head', 'meta_store_woocommerce_remove_actions');
...
add_action('meta_store_page_banner', 'meta_store_woocommerce_breadcrumb');
...
if (!function_exists('meta_store_woocommerce_products_per_page')) {
     ...
     */
    function meta_store_woocommerce_products_per_page() {
        return 32;
    }

}

add_filter('loop_shop_per_page', 'meta_store_woocommerce_products_per_page');

if (!function_exists('meta_store_woocommerce_thumbnail_columns')) {
     ...
     */
    function meta_store_woocommerce_thumbnail_columns() {
        return 4;
    }

}

add_filter('woocommerce_product_thumbnails_columns', 'meta_store_woocommerce_thumbnail_columns');

if (!function_exists('meta_store_woocommerce_loop_columns')) {
     ...
     */
    function meta_store_woocommerce_loop_columns() {
        return 3;
    }

}

add_filter('loop_shop_columns', 'meta_store_woocommerce_loop_columns');

if (!function_exists('meta_store_woocommerce_related_products_args')) {
     ...
     */
    function meta_store_woocommerce_related_products_args($args) {
        $defaults = array(
            'posts_per_page' => 3,
            'columns' => 3,
        );
...
add_filter('woocommerce_output_related_products_args', 'meta_store_woocommerce_related_products_args');

if (!function_exists('meta_store_woocommerce_cross_sells_columns')) {

    function meta_store_woocommerce_cross_sells_columns() {
        return 4;
    }

}

add_filter('woocommerce_cross_sells_columns', 'meta_store_woocommerce_cross_sells_columns');
...
if (!function_exists('meta_store_product_search_form')) {
    ...
    function meta_store_product_search_form() {
        ...
        ?>
        <form role="search" method="get" class="ms-product-search-form" action="<?php echo esc_url(home_url('/')); ?>">
            <?php
...
if (!function_exists('meta_store_mobile_product_search_form')) {
    ...
    function meta_store_mobile_product_search_form() {
        ...
        <div class="ms-mobile-product-search-form-wrap">
            <form role="search" method="get" class="ms-product-search-form ms-mobile-product-search-form" action="<?php echo esc_url(home_url('/')); ?>">
                <?php
                if (taxonomy_exists('product_cat')) {
                    $cat_args = array(
                        'taxonomy' => 'product_cat',
