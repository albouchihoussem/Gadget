...
function vw_corporate_business_widgets_init() {
	...
	register_sidebar( array(
		...
		'description'   => __( 'Appears on single product page', 'vw-corporate-business' ),
...
function vw_corporate_business_scripts() {
	...
	wp_enqueue_style( 'vw-corporate-business-block-style', get_theme_file_uri('/css/blocks.css') );
	wp_enqueue_style( 'vw-corporate-business-block-patterns-style-frontend', get_theme_file_uri('/inc/block-patterns/css/block-frontend.css') );
	...
	wp_add_inline_style( 'vw-corporate-business-basic-style',$vw_corporate_business_custom_css );	
	wp_enqueue_style( 'vw-corporate-business-effect', esc_url(get_template_directory_uri()).'/css/effect.css' );
	...
	wp_enqueue_script( 'vw-corporate-business-custom-scripts-jquery', esc_url(get_template_directory_uri()) . '/js/custom.js', array('jquery') );
 ...
 */
function vw_corporate_business_block_editor_styles() {
	wp_enqueue_style( 'vw-corporate-business-font', vw_corporate_business_font_url(), array() );
    wp_enqueue_style( 'vw-corporate-business-block-patterns-style-editor', get_theme_file_uri( '/inc/block-patterns/css/block-editor.css' ), false, '1.0', 'all' );
    wp_enqueue_style( 'bootstrap-style', esc_url(get_template_directory_uri()).'/css/bootstrap.css' );
    wp_enqueue_style( 'font-awesome', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css' );
}
add_action( 'enqueue_block_editor_assets', 'vw_corporate_business_block_editor_styles' );
...
function vw_corporate_business_sanitize_float( $input ) {
	return filter_var($input, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
}

function vw_corporate_business_sanitize_number_range( $number, $setting ) {
...
function vw_corporate_business_sanitize_email( $email, $setting ) {
...
function vw_corporate_business_sanitize_phone_number( $phone ) {
...
define('VW_CORPORATE_BUSINESS_FREE_THEME_DOC',__('https://www.vwthemesdemo.com/docs/free-vw-corporate-business/','vw-corporate-business'));
define('VW_CORPORATE_BUSINESS_SUPPORT',__('https://wordpress.org/support/theme/vw-corporate-business/','vw-corporate-business'));
define('VW_CORPORATE_BUSINESS_REVIEW',__('https://wordpress.org/support/theme/vw-corporate-business/reviews/','vw-corporate-business'));
define('VW_CORPORATE_BUSINESS_BUY_NOW',__('https://www.vwthemes.com/themes/wordpress-themes-for-business/','vw-corporate-business'));
define('VW_CORPORATE_BUSINESS_LIVE_DEMO',__('https://www.vwthemes.net/vw-business-pro/','vw-corporate-business'));
define('VW_CORPORATE_BUSINESS_PRO_DOC',__('https://www.vwthemesdemo.com/docs/vw-corporate-business-pro/','vw-corporate-business'));
define('VW_CORPORATE_BUSINESS_FAQ',__('https://www.vwthemes.com/faqs/','vw-corporate-business'));
define('VW_CORPORATE_BUSINESS_CHILD_THEME',__('https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-corporate-business'));
define('VW_CORPORATE_BUSINESS_CONTACT',__('https://wordpress.org/support/theme/vw-corporate-business/','vw-corporate-business'));

define('VW_CORPORATE_BUSINESS_CREDIT',__('https://www.vwthemes.com/themes/free-wordpress-themes-for-business/','vw-corporate-business'));
...
add_filter('loop_shop_columns', 'vw_corporate_business_loop_columns');
	...
	function vw_corporate_business_loop_columns() {
		return get_theme_mod( 'vw_corporate_business_products_per_row', '3' ); 
		// 3 products per row
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'vw_corporate_business_products_per_page' );
function vw_corporate_business_products_per_page( $cols ) {
  	return  get_theme_mod( 'vw_corporate_business_products_per_page',9);
}
