...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod('vw_corporate_business_slider_hide_show') != ''){ ?>
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod( 'vw_corporate_business_slider_speed',3000)) ?>"> 
