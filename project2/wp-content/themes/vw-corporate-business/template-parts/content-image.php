    ...
    if($vw_corporate_business_theme_lay == 'Default'){ ?>
      <div class="row">
        ...
        <div class="service-text <?php if(has_post_thumbnail()) { ?>col-lg-6 col-md-6"<?php } else { ?>col-lg-12 col-md-12" <?php } ?>>
          ...
          <?php if( get_theme_mod( 'vw_corporate_business_toggle_postdate',true) != '' || get_theme_mod( 'vw_corporate_business_toggle_author',true) != '' || get_theme_mod( 'vw_corporate_business_toggle_comments',true) != '') { ?>
            <div class="post-info">
